    ...
    return (
        <div className='flex flex-col h-screen'>
            ...
            <div className='flex justify-between p-4'>
                <div>
                    <Image src="/logo.svg" alt="logo" width={100} height={100} className='hidden md:block relative -top-1' />
            ...
            <div className='bg-[#2b3445] text-white h-10 py-2 flex justify-between px-4 relative -top-5 rounded-md text-2xl  cursor-pointer' >
