          ...
          <Table className="min-w-full divide-y divide-gray-200">
            ...
            <TableBody className="bg-white divide-y divide-gray-200">
              <TableRow>
                ...
                <TableCell className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Alibaba</TableCell>
                <TableCell className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Alibaba Image</TableCell>
